...
**[Inspector](/angular/ms-agent-python/inspector)** is the page to read for what the panes show and how
...
- [Inspector](/angular/ms-agent-python/inspector)
- [Troubleshooting Angular apps](/angular/ms-agent-python/guides/troubleshooting)
- [AG-UI Event Inspector](/angular/ms-agent-python/troubleshooting/event-inspector)
